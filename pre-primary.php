...
<head>
    ...
    <meta name="description" content="Pre-primary Program at Stanford International School">
    <title>Pre-Primary | Stanford International School</title>
    ...
    <style>
        .page-header {
            background: linear-gradient(rgba(15,23,42,0.8), rgba(15,23,42,0.8)), url('img/new-images/banner1.webp') center/cover;
...
<body style="background: var(--bg-color);">
    ...
    <div class="page-header">
        <div class="container reveal">
            <h1 class="hero-title">Pre-Primary <span>Program</span></h1>
            <p class="hero-desc">Laying a solid foundation for your child's formal learning process.</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="academic-content reveal">
                <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
                    <div class="service-icon" style="margin: 0;"><i class="fas fa-shapes"></i></div>
                    <h2 class="section-title" style="margin: 0; text-align: left;">Welcome to Pre-Primary</h2>
                </div>
                
                <p style="font-size: 1.1rem; color: var(--text-main); margin-bottom: 1.5rem; line-height: 1.8;">
                    Pre-schooling plays a crucial role in laying a solid foundation for your child’s formal learning process. Our Pre-Primary program focuses on developing cognitive, physical, social, and emotional skills in a balanced way.
                </p>
                <p style="font-size: 1.1rem; color: var(--text-main); margin-bottom: 1.5rem; line-height: 1.8;">
                    By integrating fun activities with structured learning, we help young children transition smoothly into a more academic environment, building their confidence, independence, and a natural love for learning.
                </p>
                ...
                <div style="margin-top: 3rem;">
                    ...
                    <ul style="list-style: none; padding: 0; display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem;">
                        <li style="display: flex; gap: 10px; align-items: center; color: var(--text-muted);"><i class="fas fa-check-circle" style="color: var(--secondary);"></i> Activity-Based Learning</li>
                        <li style="display: flex; gap: 10px; align-items: center; color: var(--text-muted);"><i class="fas fa-check-circle" style="color: var(--secondary);"></i> Language Development</li>
                        <li style="display: flex; gap: 10px; align-items: center; color: var(--text-muted);"><i class="fas fa-check-circle" style="color: var(--secondary);"></i> Social Interaction</li>
                        <li style="display: flex; gap: 10px; align-items: center; color: var(--text-muted);"><i class="fas fa-check-circle" style="color: var(--secondary);"></i> Creative Arts & Crafts</li>
                    </ul>
                </div>
